            ...
            <div class="container-fluid d-flex align-items-center justify-content-between">
                <div class="navbar-header">
                    ...
                    <!-- Navbar Header--><a href="<?php echo base_url(); ?>Admin/Listar" class="navbar-brand">
                        <div class="brand-text brand-big visible"><strong class="text-primary">RED </strong><strong class="text-white">INCO</strong></div>
                        <div class="brand-text brand-sm"><strong class="text-primary">Mate</strong><strong>riales</strong></div>
                    </a>
                    <!-- Sidebar Toggle Btn-->
                    <button class="sidebar-toggle"><i class="fas fa-arrow-alt-circle-left"></i></button>
                </div>
                <div class="right-menu list-inline no-margin-bottom">
                    <h4>Sistema de Materiales </h4>
                    <!-- <strong class="text-primary">Ec, <?php echo date("d-M-Y") ?></strong> -->
                </div>
                <!-- Log out               -->
